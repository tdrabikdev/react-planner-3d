...
function Area(_ref) {
  ...
  renderedAreaSize = /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("text", {
    x: "0",
    y: "0",
    transform: "translate(".concat(center[0], " ").concat(center[1], ") scale(1, -1)"),
    style: STYLE_TEXT
  }, area.name), /*#__PURE__*/_react["default"].createElement("text", {
    x: "0",
    y: "14",
    transform: "translate(".concat(center[0], " ").concat(center[1], ") scale(1, -1)"),
    style: STYLE_TEXT
  }, "(", (areaSize / 10000).toFixed(2), " m", /*#__PURE__*/_react["default"].createElement("tspan", {
